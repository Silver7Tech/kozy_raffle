            ...
            <>
                <div className="flex flex-col md:flex-row items-center justify-evenly sm:mt-10">
                    ...
                    <div className="flex flex-col p-5 border-2 border-white rounded-3xl mt-5 sm:mt-0">
                        ...
                        <p className="text-white text-0sm mt-5">Total $KOZY spent : {location.state.ticketIndex * location.state.ticketPrice} $KOZY</p>
                        ...
                        <p className="text-white font-bold text-1sm">PRICE PER TICKET : {location.state.ticketPrice} $KOZY</p>
